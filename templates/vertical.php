...
echo '<div class="infoviewContainer infoviewContainerVertical" data-dcode="'.$dcode.'" data-dtuid="'.$dtuid.'">';
...
foreach ($groups as $nx=>$fkey) {
	...
	if($nx==0) {
		echo '<a role="button" aria-expanded="true" aria-controls="collapse'.$panelID.'" data-parent="#accordion'.$accordionID.'" href="#collapse'.$panelID.'" onclick="viewpaneContentShown(this)" >'.$title.'</a>';
	} else {
		echo '<a role="button" aria-expanded="false" aria-controls="collapse'.$panelID.'" data-parent="#accordion'.$accordionID.'" href="#collapse'.$panelID.'" onclick="viewpaneContentShown(this)" >'.$title.'</a>';
	}
	echo '</h4>';
	echo '</div>';
